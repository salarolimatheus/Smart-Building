...
cp ./mosquitto-conf/mosquitto.conf /var/lib/docker/volumes/sb-docker_mosquitto-config/_data/mosquitto.conf
...
chmod 777 /var/lib/docker/volumes/sb-docker_mosquitto-config/_data/mosquitto.conf
chown 1000:1000 /var/lib/docker/volumes/sb-docker_mosquitto-config/_data/mosquitto.conf
